    ...
    <div class="nl-content">
        ...
        <div id="custom_display_2">
            <p class="nl-login-intro" id="message_LOGIN_LINKS">
                <a href="http://www.xiaomi.com/" target="_blank">酒查查手机</a>，
                <a href="http://www.xiaomi.com/index.php" target="_blank">酒查查网</a>，
                <a href="http://www.miui.com/" target="_blank">MIUI米柚</a>，
        ...
        <div class="nl-frame-container">
            <div class="ng-form-area show-place" id="form-area">
                ...
                <div class="miniLogin_forbidden" id="miniLogin_forbidden">
                    <div>
                        <span id="message_LOGIN_TOO_MUCH">您的操作频率过快，请稍后再试。</span>
                ...
                <input class="button orange" type="submit"
                       id="message_LOGIN_IMMEDIATELY" value="关联新账户"
                       onclick="javascript:location.href='locaRegister?source=qq'">


                <span id="custom_display_128" onclick="javascript:location.href='localLogin?source=qq'">
