...
<div class="layout">
        ...
        <div class="nl-logo-area" id="custom_display_1">
            <a href="javascript:void(0)">
                <img id="logo-img"
                     ...
                     onerror="this.src=&#39;/static/img/passport/nl-logo.png&#39;" width="60">
            </a>
        </div>

        <h1 class="nl-login-title" id="custom_display_256"><span id="message_LOGIN_TITLE">一个帐号，玩转所有酒查查服务！</span></h1>
        <h2 class="nl-login-title lsrp-appname display-custom-hide" id="lsrp_appName"></h2>

        <div id="custom_display_2">
            <p class="nl-login-intro" id="message_LOGIN_LINKS"><a href="http://www.xiaomi.com/"
                                                                  target="_blank">酒查查手机</a>，<a
                        href="http://www.xiaomi.com/index.php" target="_blank">酒查查网</a>，<a href="http://www.miui.com/"
                                                                                           target="_blank">MIUI米柚</a>，<a
                        href="http://www.duokan.com/" target="_blank">多看阅读</a>，<a href="http://www.miliao.com/"
                                                                                  target="_blank">米聊</a></p>
        </div>

        <div class="nl-phone-tip">
            <div id="message_LOGIN_PHONETIP">非大陆地区请在手机号码前面添加当地的国际代码前缀(如香港 +852 台湾 +886)</div>
                ...
                <form method="post" action="login" id="miniLogin"
                    ...
                    <div class="shake-area" id="shake_area" style="z-index:30;">
                        ...
                        <div class="enter-area" id="enter_user">
                            <input type="text" name="phone" class="enter-item first-enter-item"
                                   data-rule="(^[\w.\-]+@(?:[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*\.)+[A-Za-z]{2,6}$)|(^1\d{10}$)|(^\d{3,}$)|(^\++\d{2,}$)"
                                   id="miniLogin_username" autocomplete="off" placeholder="邮箱/手机号码/酒查查帐号">
                            <i class="placeholder hide" id="message_INPUT_IDENTITY">邮箱/手机号码/酒查查帐号</i>
                            <span class="error-tip"><em class="error-ico"></em><span class="error-msg"></span></span>
                        </div>
                        <div class="enter-area" style="z-index:20;">
                            <input type="password" name="password" class="enter-item last-enter-item" id="miniLogin_pwd"
                                   autocomplete="off" data-rule="" placeholder="密码">
                    ...
                    <div class="enter-area img-code-area" id="img_code_area" style="display:none;">
                        <input type="text" class="enter-item code-enter-item" id="miniLogin_captCode" autocomplete="off"
                               maxlength="12" placeholder="验证码">
                        <img src="" class="code-img" id="code_img">
                        <i class="placeholder hide" id="message_INPUT_CONFIRM">验证码</i>
                        <span class="error-tip"><em class="error-ico"></em><span class="error-msg"
                                                                                 id="code_error_tips"></span></span>
                    </div>

                    <div class="miniLogin_forbidden" id="miniLogin_forbidden">
                        <div><span id="message_LOGIN_TOO_MUCH">您的操作频率过快，请稍后再试。</span>(<span id="retryCountdown"></span>)
                        </div>
                    </div>
                    ...
                    <div class="ng-foot clearfix">
                        ...
                        <div class="ng-link-area">
                            <span> <a href="https://account.xiaomi.com/pass/sns/login/auth?appid=100284651&callback=http%3A%2F%2Fm.mi.com%2Fmshopapi%2Fv1%2Fauthorize%2Fsso_callback%3Ffollowup%3Dhttp%253A%252F%252Fm.mi.com%252Findex.html%2523ac%253Daccount%2526op%253Dindex%26sign%3DYjJhY2VjZWEwZDYzOTNhNmZhOTRjYmRmMDVlN2ZlZTJhZDFhOTViOA%2C%2C&sid=mi_eshopm"
                                      id="other_method_default">QQ联合登录</a><span> | </span> </span>
                            <span id="custom_display_16"> <a href="javascript:void(0);"
                                                             id="other_method">其他方式登录</a> <span> | </span> </span>
                            <span id="custom_display_64"> <a
                                        ...
                                        id="message_FORGET_PASSWORD" target="_blank">忘记密码？</a> </span>
                    ...
                    <span id="custom_display_128"> <a
                                href="localRegister"
                                class="button" id="message_REGISTER">注册帐号</a> </span>
                    <span id="custom_display_8"> <a
                                href="authorizeUrl"
                                id="facebook_login_button" class="button facebook_area"> <i class="iconfacebook"></i>Facebook登录 </a> </span>
    ...
    <div class="modal-container display-custom-hide" id="qrlogin-container">
        ...
        <iframe id="qrlogin-iframe" frameborder="0" border="0" class="qrlogin-iframe"
